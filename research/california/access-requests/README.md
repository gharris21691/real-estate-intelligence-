...
| --- | --- | --- | --- | --- | --- |
| 1 | Sacramento secured assessment roll | `assessor@saccounty.gov`; [detailed checklist](../sacramento/agency-requests.md) | **Access obtained**; land-use references received on 2026-08-13 | Record the roll layout, effective date, update schedule, parcel-status definitions, and written use terms; confirm the land-use references apply | Access and land-use-reference items complete; other gates pending |
